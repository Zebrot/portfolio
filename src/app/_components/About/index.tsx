...
const tools = [
  ...
  },
  {
    ...
    tools : [
      ...
      {name : 'github', image : '/svg/logos/github.svg'},
...
export default function About() {
    return (
      <>
        <div className="shadow-sm p-8 py-15 rounded-lg bg-ultraLightGrey text-opacityGrey text-center my-15 flex flex-col gap-5 text-[24px] w-[80%] mx-auto">
          <p>
          ...
          <div className="flex flex-col gap-10 my-20 px-2">
            <h3 className="-mb-5 text-center text-opacityGrey text-[24px]">mes outils</h3>
